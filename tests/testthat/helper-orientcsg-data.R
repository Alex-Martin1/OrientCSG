...
dicom_ipp_1_flip_xy <- "0020,0032 Image Position (Patient): 0\\0\\0"
dicom_ipp_2_flip_xy <- "0020,0032 Image Position (Patient): 0\\0\\0.3"
...
bonej_results_row_tibia <- paste(
  ...
  "0.7145697774398292",
  "-0.6994181694574788",
  "0.014291864900787515",
  "-0.6995637919203548",
  "-0.714441596022327",
  "0.013553852112399943",
  sep = "\t"
)
